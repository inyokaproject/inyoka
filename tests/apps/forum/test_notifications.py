...
class TestNotifications(TestCase):
    ...
    def test_report(self):
        ...
        self.assertIn(u'(http://forum.ubuntuusers.local:8080/topic/a-test-topic/)', mail1.body)
        ...
        self.assertIn(u'http://forum.ubuntuusers.local:8080/reported_topics/', mail1.body)
        ...
        self.assertIn(u'(http://forum.ubuntuusers.local:8080/topic/a-test-topic/)', mail2.body)
        ...
        self.assertIn(u'http://forum.ubuntuusers.local:8080/reported_topics/', mail2.body)
