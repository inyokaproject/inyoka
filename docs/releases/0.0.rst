...
* Remove leading and trailing whitespaces that break the javascript to display
  the selected search area. Fixes `#799
  <http://trac.inyokaproject.org/ticket/799>`_
...
* Fixes `#700 <http://trac.inyokaproject.org/ticket/700>`_ again. Capitalize
  the numbers for the number of Ikhaya comments and print the human numbers in
  the portal view, too.
...
* Added "trans" to "Show my profile" string. Fixes `#797
  <http://trac.inyokaproject.org/ticket/797>`_.
* Correctly close <div> tags in the Ikhaya article suggestion list. Fixes `#796
  <http://trac.inyokaproject.org/ticket/796>`_
...
* fixed `#710 <http://trac.inyokaproject.org/ticket/710>`_ by incrementing gpg
  key length to 255.
* fixed title length validation on post edits.
* compile translations.
* Testcommit for GithubTrac, fixed `#782
  <http://trac.inyokaproject.org/ticket/782>`_
* simpler fix for the previous fix ;)
* Fix other possible bugs and add test for attachment adding
* Fix `#782 <http://trac.inyokaproject.org/ticket/782>`_ and add missing
  translation
...
* Fix egosearch pagination. See `#646
  <http://trac.inyokaproject.org/ticket/646>`_
...
* A 1 to much
* Fix empty pages in /last24/ regarding PR 76 and `#617
  <http://trac.inyokaproject.org/ticket/617>`_
...
* Fix `#617 <http://trac.inyokaproject.org/ticket/617>`_. Maybe performace
  issues created
