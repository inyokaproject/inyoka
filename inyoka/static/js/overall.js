...
$(document).ready(function () {
  ...
  (function () {
    ...
    var block = $("#counter")
    if (days > 21) {
      block.html('<a href="http://www.ubuntu.com"><img src="' + $STATIC_URL + 'img/portal/countdown/oneiricbanner_start.png" alt="Ubuntu 11.10"></a>');
    }
    if (days >= 1 && days<=21) {
      block.html('<a href="http://www.ubuntu.com"><img src="' + $STATIC_URL + 'img/portal/countdown/oneiricbanner_' + days + '.png" alt="Ubuntu 11.10"></a>');
    }
    if (days == 0) {
      block.html('<a href="http://www.ubuntu.com"><img src="' + $STATIC_URL + 'img/portal/countdown/oneiricbanner_soon.png" alt="Ubuntu 11.10"></a>');
    }
    if (days < 0) {
      block.html('<a href="http://www.ubuntu.com"><img src="' + $STATIC_URL + 'img/portal/countdown/oneiricbanner_here.png" alt="Ubuntu 11.10"></a>');
    }
  })();
