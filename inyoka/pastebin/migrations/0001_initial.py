    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', inyoka.utils.database.PygmentsField(application=b'pastebin')),
                ('rendered_code_old', models.TextField(verbose_name='Rendered code', db_column=b'rendered_code')),
