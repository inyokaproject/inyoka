...
@permission_required('ikhaya.change_article', raise_exception=True)
@confirm_action(message=ugettext_lazy(u'Do you want to hide this report?'),
                confirm=ugettext_lazy(u'Hide'),
...
@permission_required('ikhaya.change_article', raise_exception=True)
@confirm_action(message=ugettext_lazy(u'Do you want to restore this report?'),
...
@permission_required('ikhaya.change_article', raise_exception=True)
@confirm_action(message=ugettext_lazy(u'Do you want to mark this report as solved?'),
                confirm=ugettext_lazy(u'Mark as solved'),
                cancel=ugettext_lazy(u'Cancel'))
...
@permission_required('ikhaya.change_article', raise_exception=True)
@confirm_action(message=ugettext_lazy(u'Do you want to mark this report as unsolved?'),
                confirm=ugettext_lazy(u'Mark as unsolved'),
                cancel=ugettext_lazy(u'Cancel'))
...
@confirm_action(message=ugettext_lazy(u'Do you want to hide this comment?'),
                confirm=ugettext_lazy(u'Hide'),
                cancel=ugettext_lazy(u'Cancel'))
...
@confirm_action(message=ugettext_lazy(u'Do you want to restore this comment?'),
                confirm=ugettext_lazy(u'Restore'),
                cancel=ugettext_lazy(u'Cancel'))
