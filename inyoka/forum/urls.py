...
urlpatterns = patterns('inyoka.forum.views',
    ...
    (r'^topic/(?P<topic_slug>[^/]+)/solve/$', 'change_status', {'solved': True}),
    (r'^topic/(?P<topic_slug>[^/]+)/unsolve/$', 'change_status', {'solved': False}),
    (r'^topic/(?P<topic_slug>[^/]+)/lock/$', 'change_lock_status', {'locked': True}),
    (r'^topic/(?P<topic_slug>[^/]+)/unlock/$', 'change_lock_status', {'locked': False}),
    (r'^topic/(?P<topic_slug>[^/]+)/report/$', 'report'),
    (r'^topic/(?P<topic_slug>[^/]+)/report_done/$', 'report', {'status': 'done'}),
    ...
    (r'^post/(?P<post_id>\d+)/(?P<action>ham|spam)/$', 'mark_ham_spam'),
    ...
    (r'^author/(?P<user>[^/]+)/$', 'postlist'),
    (r'^author/(?P<user>[^/]+)/(?P<page>\d+)/$', 'postlist'),
    (r'^author/(?P<user>[^/]+)/topic/(?P<topic_slug>[^/]+)/$', 'postlist'),
    (r'^author/(?P<user>[^/]+)/topic/(?P<topic_slug>[^/]+)/(?P<page>\d+)/$', 'postlist'),
    (r'^author/(?P<user>[^/]+)/forum/(?P<forum_slug>[^/]+)/$', 'postlist'),
    (r'^author/(?P<user>[^/]+)/forum/(?P<forum_slug>[^/]+)/(?P<page>\d+)/$', 'postlist'),
