...
urlpatterns = [
    ...
    url(r'^topic/(?P<topic_slug>[^/]+)/reply/$', views.reply_to_topic),
    ...
    url(r'^post/(?P<quote_id>\d+)/quote/$', views.reply_to_topic),
    ...
    url(r'^forum/(?P<forum_slug>[^/]+)/newtopic/$', views.create_topic),
    ...
    url(r'^new_discussion/(?P<page_name>.+)/$', views.create_topic),
