...
urlpatterns = [
    ...
    url(r'^topic/(?P<topic_slug>[^/]+)/reply/$', views.create_and_edit_post),
    ...
    url(r'^post/(?P<post_id>\d+)/edit/$', views.create_and_edit_post),
    url(r'^post/(?P<quote_id>\d+)/quote/$', views.create_and_edit_post),
    ...
    url(r'^forum/(?P<forum_slug>[^/]+)/newtopic/$', views.create_and_edit_post),
    ...
    url(r'^new_discussion/(?P<page_name>.+)/$', views.create_and_edit_post),
