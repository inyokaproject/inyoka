...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'User.gpgkey'
        db.alter_column('portal_user', 'gpgkey', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Changing field 'User.gpgkey'
        db.alter_column('portal_user', 'gpgkey', self.gf('django.db.models.fields.CharField')(max_length=8))
    ...
    models = {
        ...
        'portal.user': {
            ...
            'gpgkey': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
