...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.new_password_key'
        db.delete_column(u'portal_user', 'new_password_key')

    def backwards(self, orm):
        # Adding field 'User.new_password_key'
        db.add_column(u'portal_user', 'new_password_key',
    ...
    models = {
        ...
        u'portal.user': {
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 30, 18, 37, 58, 17935)'}),
