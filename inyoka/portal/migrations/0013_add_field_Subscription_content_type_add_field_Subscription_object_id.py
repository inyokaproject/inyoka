...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.content_type'
        db.add_column('portal_subscription', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # Adding field 'Subscription.object_id'
        db.add_column('portal_subscription', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Subscription.content_type'
        db.delete_column('portal_subscription', 'content_type_id')

        # Deleting field 'Subscription.object_id'
        db.delete_column('portal_subscription', 'object_id')
