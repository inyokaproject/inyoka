...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrivateMessage.author'
        db.alter_column(u'portal_privatemessage', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.User'], on_delete=models.PROTECT))

        # Changing field 'PrivateMessageEntry.user'
        db.alter_column(u'portal_privatemessageentry', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.User'], on_delete=models.PROTECT))

        # Changing field 'PrivateMessageEntry.message'
        db.alter_column(u'portal_privatemessageentry', 'message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.PrivateMessage'], on_delete=models.PROTECT))

        # Changing field 'Event.author'
        db.alter_column('portal_event', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.User'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'PrivateMessage.author'
        db.alter_column(u'portal_privatemessage', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.User']))

        # Changing field 'PrivateMessageEntry.user'
        db.alter_column(u'portal_privatemessageentry', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.User']))

        # Changing field 'PrivateMessageEntry.message'
        db.alter_column(u'portal_privatemessageentry', 'message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.PrivateMessage']))

        # Changing field 'Event.author'
        db.alter_column('portal_event', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.User']))
    ...
    models = {
        ...
        u'portal.privatemessageentry': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['portal.PrivateMessage']", 'on_delete': 'models.PROTECT'}),
            'read': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['portal.User']", 'on_delete': 'models.PROTECT'})
        },
