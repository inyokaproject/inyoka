...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('portal_subscription', 'article_id', models.ForeignKey(orm['ikhaya.Article'], null=True, blank=True))


    def backwards(self, orm):
        db.alter_column('portal_subscription', 'article_id', models.IntegerField(null=True, blank=True))
