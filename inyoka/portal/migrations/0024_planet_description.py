...
PLANET_DESCRIPTION = u'Der ubuntuusers-Planet sammelt verschiedene Blogs zu Ubuntu und Linux'


class Migration(DataMigration):

    def forwards(self, orm):
        orm.Storage.objects.create(key='planet_description', value=PLANET_DESCRIPTION)

    def backwards(self, orm):
        orm.Storage.objects.filter(key='planet_description').delete()
