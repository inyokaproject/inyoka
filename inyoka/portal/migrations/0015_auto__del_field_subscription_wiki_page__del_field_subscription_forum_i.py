...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subscription.wiki_page'
        db.delete_column('portal_subscription', 'wiki_page_id')

        # Deleting field 'Subscription.forum_id'
        db.delete_column('portal_subscription', 'forum_id')

        # Deleting field 'Subscription.article'
        ...
        # Deleting field 'Subscription.topic_id'
        db.delete_column('portal_subscription', 'topic_id')


    def backwards(self, orm):

        # Adding field 'Subscription.wiki_page'
        db.add_column('portal_subscription', 'wiki_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wiki.Page'], null=True), keep_default=False)

        # Adding field 'Subscription.forum_id'
        ...
        # Adding field 'Subscription.topic_id'
        db.add_column('portal_subscription', 'topic_id', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
