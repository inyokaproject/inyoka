...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'portal_userpage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['portal.User'], unique=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('content_rendered', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'portal', ['UserPage'])


    def backwards(self, orm):
        # Deleting model 'UserPage'
        db.delete_table(u'portal_userpage')
    ...
    models = {
        ...
        u'portal.userpage': {
            ...
            'content': ('django.db.models.fields.TextField', [], {}),
            'content_rendered': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['portal.User']", 'unique': 'True'})
        }
    }
