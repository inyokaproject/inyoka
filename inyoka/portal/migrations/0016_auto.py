...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Subscription', fields ['object_id']
        db.create_index('portal_subscription', ['object_id'])


    def backwards(self, orm):

        # Removing index on 'Subscription', fields ['object_id']
        db.delete_index('portal_subscription', ['object_id'])
