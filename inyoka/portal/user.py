...
class User(AbstractBaseUser):
    ...
    def has_content(user):
        ...
        """
        return (user.post_count or
                user.post_set.exists() or
                user.topics.exists() or
                user.comment_set.exists() or
                user.privatemessageentry_set.exists() or
                user.wiki_revisions.exists() or
                user.article_set.exists() or
                user.entry_set.exists() or
                user.event_set.exists() or
                user.suggestion_set.exists() or
                user.subscription_set.exists())
