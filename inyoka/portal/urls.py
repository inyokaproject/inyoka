...
urlpatterns = [
    ...
    url(r'^ticketreason/list/$', views.ticket_reasons_list),
    url(r'^ticketreason/new/$', views.ticket_reason_edit),
    url(r'^ticketreason/all/(?P<mode>(un)?subscribe)/$', views.ticket_reason_subscription, {'reason_id': 'all'}),
    url(r'^ticketreason/(?P<reason_id>\d+)/edit/', views.ticket_reason_edit),
    url(r'^ticketreason/(?P<reason_id>\d+)/delete/', views.ticket_reason_delete),
    url(r'^ticketreason/(?P<reason_id>\d+)/(?P<mode>(un)?subscribe)/$', views.ticket_reason_subscription),
    url(r'^tickets/list/$', views.ticket_list),
    url(r'^tickets/(?P<ticket_id>\d+)/own/$', views.ticket_own),
    url(r'^tickets/(?P<ticket_id>\d+)/disown/$', views.ticket_disown),
    url(r'^tickets/(?P<ticket_id>\d+)/edit/$', views.ticket_edit),
