...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('news_article', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))

        # Adding index on 'Article', fields ['slug']
        db.create_index('news_article', ['slug'])


    def backwards(self, orm):

        # Removing index on 'Article', fields ['slug']
        db.delete_index('news_article', ['slug'])

        # Changing field 'Article.slug'
        db.alter_column('news_article', 'slug', self.gf('django.db.models.fields.CharField')(max_length=100))
