...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Entry', fields ['updated']
        db.create_index('planet_entry', ['updated'])

        # Adding index on 'Entry', fields ['pub_date']
        db.create_index('planet_entry', ['pub_date'])


    def backwards(self, orm):

        # Removing index on 'Entry', fields ['pub_date']
        db.delete_index('planet_entry', ['pub_date'])

        # Removing index on 'Entry', fields ['updated']
        db.delete_index('planet_entry', ['updated'])
